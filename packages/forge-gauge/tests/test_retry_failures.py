...
class TestCLIValidation:
    """Test CLI argument validation for --retry-failures."""

    def test_retry_and_resume_mutually_exclusive(self, tmp_path, monkeypatch):
        """Test that --retry-failures and --resume are mutually exclusive."""
        from forge_gauge.plugins.gauge_core.scan_command import execute_scan
    ...
    def test_skip_permanent_requires_retry_failures(self, monkeypatch):
        """Test that --skip-permanent-failures requires --retry-failures."""
        from forge_gauge.plugins.gauge_core.scan_command import execute_scan
        ...
        args = argparse.Namespace(
            ...
            checkpoint_file=Path(".gauge_checkpoint.json"),
            with_all=False,
        )
    ...
    def test_retry_failures_requires_checkpoint(self, tmp_path, monkeypatch):
        """Test that --retry-failures requires checkpoint file to exist."""
        from forge_gauge.plugins.gauge_core.scan_command import execute_scan
